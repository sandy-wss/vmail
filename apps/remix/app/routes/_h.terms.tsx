  ...
  return (
    <div className="mx-10 mt-24 text-white">
      <div className="max-w-[1400px] ">
        ...
        <p className="mt-8">
          Welcome to TMAIL.PUB! These Terms of Service ("Terms") govern your
        ...
        <p className="mt-4">
          TMAIL.PUB is a minimalistic temporary email service that allows you to
          ...
          TMAIL.PUB operates on the Cloudflare network, guaranteeing a
        ...
        <p className="mt-4">
          2.1 Availability: Please note that TMAIL.PUB is not available in China
          Mainland. We apologize for any inconvenience caused.
        </p>
        <p className="mt-4">
          2.2 Copyright: All copyrights related to TMAIL.PUB and its services
          belong to TMAIL.PUB. You may not copy, reproduce, distribute, modify,
          or create derivative works of TMAIL.PUB or any part thereof without
          explicit permission from TMAIL.PUB.
        </p>
        ...
        <p className="mt-4">
          ...
          personal information to use TMAIL.PUB. However, you are solely
          responsible for maintaining the confidentiality of any temporary email
          addresses generated through our service.
        </p>
        <p className="mt-4">
          3.2 Prohibited Activities: While using TMAIL.PUB, you agree not to
        ...
        <p className="mt-4">
          TMAIL.PUB is provided on an "as is" and "as available" basis. We do
          not warrant that our services will be uninterrupted, error-free, or
          secure. Your use of TMAIL.PUB is at your own risk, and we disclaim all
        ...
        <p className="mt-4">
          To the maximum extent permitted by law, in no event shall TMAIL.PUB or
          ...
          from your access to or use of TMAIL.PUB or any content or services
          provided through TMAIL.PUB.
        </p>
        ...
        <p className="mt-4">
          ...
          posting. Your continued use of TMAIL.PUB after the posting of any
        ...
        <p className="mt-4">
          ...
          laws of the jurisdiction where TMAIL.PUB is located. Any disputes
